...
class Eeg:
    ...
    def __init__(self, board_id=BoardIds.CYTON_DAISY_BOARD, ip_port=6677, serial_port=None, headset='michael', new=False):
        """
        ...
        self.new_helmet = new
        if self.new_helmet:
            # This Message instructs the cyton dongle to configure electrodes gain as X6, 
            # and turn off last 3 electrodes
            # NUM_CHANNELS_REMOVE = 3
            #new_helmet
            self.HARDWARE_SETTINGS_MSG = "x1030110Xx2030110Xx3030110Xx4030110Xx5030110Xx6130000Xx7030110Xx8030110XxQ030110XxW130000XxE030110XxR130000XxT130000XxY131000XxU131000XxI131000X"
            # STIM_CHAN_NAME = "Stim Markers"
          
        else:
              #old_helmet
            self.HARDWARE_SETTINGS_MSG = "x1030110Xx2030110Xx3030110Xx4030110Xx5030110Xx6030110Xx7030110Xx8030110XxQ030110XxW030110XxE030110XxR030110XxT030110XxY131000XxU131000XxI131000X"        
        
        self.serial_port = serial_port
        # Board ID and headset name
        self.headset = headset  # string type
        self.board_id = board_id
        #remove_channel = True not used???
    ...
    def stream_on(self):
        ...
        self.board.config_board(self.HARDWARE_SETTINGS_MSG)
